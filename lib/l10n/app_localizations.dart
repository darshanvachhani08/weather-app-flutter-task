...
abstract class AppLocalizations {
  ...
  /// Text shown when no city is searched
  ///
  /// In en, this message translates to:
  /// **'Search for a city or use GPS'**
  String get searchPlaceholder;

  /// Title shown in error view
  ///
  /// In en, this message translates to:
  /// **'Oops!'**
  ...
  /// Label for humidity information
  ///
  /// In en, this message translates to:
  /// **'Humidity'**
  String get humidity;

  /// Label for wind speed information
  ///
  /// In en, this message translates to:
  /// **'Wind'**
  String get wind;

  /// Title for the 5-day forecast section
  ///
  /// In en, this message translates to:
  /// **'5-Day Forecast'**
  String get forecastTitle;

  /// Title for the weather map page
  ///
  /// In en, this message translates to:
  /// **'Weather Map'**
  String get mapTitle;
  ...
  /// Placeholder for selected location title
  ///
  /// In en, this message translates to:
  /// **'Selected Location'**
  String get selectedLocation;

  /// Short label for temperature
  ///
  /// In en, this message translates to:
  /// **'Temp'**
  String get tempShort;

  /// Loading message when fetching weather data
  ///
  /// In en, this message translates to:
  /// **'Fetching Weather Data...'**
  String get fetchingWeatherData;

  /// Application name displayed on splash screen
  ///
  /// In en, this message translates to:
  /// **'WEATHER GRAVITY'**
  String get appName;
